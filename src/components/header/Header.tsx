...
const MENU_ITEMS = [
  ...
  { text: "About Me", scrollTo: "", externalLink: "/website/about" },
...
function Header({
  ...
  const onClickMenu = (menu: any) => {
    if (menu.externalLink && !menu.scrollTo) return;
    document
    ...
    <>
        ...
        {logoOnly ? (
          ...
          <div className="right-container">
            <div className="hamburger-icon">
              <img
                className={showMenuInMobile ? "show-menu-mobile" : ""}
                onClick={onClick}
                src="/website/assets/hamburger-icon.svg"
                alt="hamburger"
              />
            </div>
          </div>
      ...
      <div className={"side-bar " + (isOpen ? "open" : "")}>
        <div className="text-right">
          <img onClick={onClick} src="/website/assets/close.svg" alt="close" />
        </div>
        <ul>
